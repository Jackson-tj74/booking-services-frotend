      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        >
          ...
          <nav className="space-y-3">
            <Link
              to="/"
              className="flex items-center gap-3 p-2 rounded hover:bg-indigo-600"
            >
              <Home size={18} /> Home
            </Link>
        ...
        {/* MAIN CONTENT */}
        <div className="flex-1 flex items-center justify-center p-6 md:ml-64 w-full">
          {/* BIG CARD */}
          <div className="w-full max-w-5xl flex flex-col md:flex-row rounded-2xl overflow-hidden shadow-2xl bg-white/90 backdrop-blur-md">
            {/* LEFT PANEL (DESKTOP ONLY) */}
            <div className="hidden md:flex w-1/2 bg-indigo-700 text-white items-center justify-center p-10">
              <div className="text-center">
                <img src={login} alt="Login" className="w-64 mx-auto mb-6" />
                <h2 className="text-3xl font-bold mb-3">Welcome Back!</h2>
                <p className="text-indigo-100 mb-4">
                  Manage your account, track progress, and access all features
                  in one place.
                </p>
